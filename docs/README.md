...
|:---|:---|:---|
| [[TESTPLAN]] | Full campaign methodology: success criteria (SC-1…SC-12), benchmark families 1–11, timing protocol, roofline construction, MFU computation, artifact manifest, and sign-off rules. | You need to understand the campaign structure, pass/fail criteria, or how families relate to each other. |
...
| [[WAN2.2]] | Integration guide tying [Wan-Video/Wan2.2](https://github.com/Wan-Video/Wan2.2) upstream to the campaign scorecard and report. Install, run, and surrogate-workload instructions. | You are evaluating Wan2.2 inference alongside hardware benchmarks. |
